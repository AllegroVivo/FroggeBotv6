...
if TYPE_CHECKING:
    from Classes import FinanceManager
################################################################################

__all__ = ("FinanceManagerMenuView",)

################################################################################
class FinanceManagerMenuView(FroggeView):

    def __init__(self, owner: User, manager: FinanceManager):
...
################################################################################
class AddTransactionButton(FroggeButton):
...
################################################################################
class ModifyTransactionButton(FroggeButton):
...
################################################################################
class RemoveTransactionButton(FroggeButton):
